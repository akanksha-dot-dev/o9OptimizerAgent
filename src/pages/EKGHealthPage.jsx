...
import EKGConfigParser from '../components/EKGConfigParser';
import EKGGraphVisualizer from '../components/EKGGraphVisualizer';
...
export default function EKGHealthPage() {
  ...
  const handleParseComplete = (ids) => {
    setCheckedItems(ids);
    setResults(evaluateEKGHealth(ids));
      ...
      <div className="analyzer-container">
        ...
        <div className="tabs" style={{ maxWidth: 600, margin: '0 auto 32px', display: 'flex', justifyContent: 'center' }}>
          ...
          <button
            ...
            style={{ flex: 1, padding: '12px 0', fontSize: '0.88rem' }}
          >
            Manual Checklist & Results ({checkedItems.length} checked)
          </button>
        </div>

        {activeTab === 'graph' && <EKGGraphVisualizer />}

        {activeTab === 'parser' && <EKGConfigParser onParseComplete={handleParseComplete} />}
